...
export var makeQueryBuilder = function makeQueryBuilder(schema) {
  return function (_ref8) {
    var _context, _context2, _concatInstanceProper;
    ...
    switch (queryType) {
      ...
      case QueryType.UPDATE:
      case QueryType.DELETE:
        return _defineProperty({}, _concatInstanceProperty(_context = "mutation ".concat(queryType.charAt(0).toUpperCase() + _sliceInstanceProperty(queryType).call(queryType, 1))).call(_context, modelName), _defineProperty({
          __variables: queryVariables
        }, _concatInstanceProperty(_context2 = "".concat(queryType)).call(_context2, modelName), (_concatInstanceProper = {
          __args: getArgs(queryType)
      ...
      case QueryType.DELETE_CASCADES:
        return _defineProperty({}, 'query Deletes', {
          __variables: queryVariables,
          checkDelete: {
            __args: getArgs(queryType),
